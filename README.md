...
- **🚶 Walk times** — each nearby stop's walk time comes from OpenRouteService's Matrix API routed
  ...
  sets), highlighted in the list while it is the selected one; a separate **Google Maps** link beside it opens walking directions, which this app
