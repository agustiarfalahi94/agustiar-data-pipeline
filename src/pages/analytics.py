...
def show():
    ...
    df_live['speed'] = df_live['speed'] * 3.6
    ...
    col3.metric("Avg Speed", f"{df_live['speed'].mean():.2f} km/h")
    ...
    with stats_col3:
        st.metric("Avg Speed", f"{df_live['speed'].mean():.2f} km/h")
        st.metric("Median Speed", f"{df_live['speed'].median():.2f} km/h")
